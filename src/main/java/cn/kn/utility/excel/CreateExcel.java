...
public class CreateExcel {
    ...
    public static void exportExcelPaper(List<CRM> list) {
        // 标题
        String[] title = { "子项目编号", "子项目名称", "主项目号", "产品名称",
                "产品型号", "总列数", "公司代码", "公司名称","利润中心代码","利润中心名称","项目地区代码",
                "项目地区名称","其他分类代码","其它分类名称","所属客户",
                "客户编码","工厂"};
        // 创建一个工作簿
